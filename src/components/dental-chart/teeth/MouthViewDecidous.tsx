import { conditionToColor } from "./utils/toothCondition";
import { Tooth } from './Tooth'
import * as React from "react";

export class MouthViewDeciduous extends React.Component<
    {
							...
							<g>
								<use
									...
									fill={conditionToColor(
										this.props.teeth[51].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" onClick={() => this.props.onClick(52)}>
							<g>
								<use
									xlinkHref="#iso-52"
									fill={conditionToColor(
										this.props.teeth[52].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" onClick={() => this.props.onClick(53)}>
							<g>
								<use
									xlinkHref="#iso-53"
									fill={conditionToColor(
										this.props.teeth[53].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="4" onClick={() => this.props.onClick(54)}>
							<g>
								<use
									xlinkHref="#iso-54"
									fill={conditionToColor(
										this.props.teeth[54].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="5" onClick={() => this.props.onClick(55)}>
							<g>
								<use
									xlinkHref="#iso-55"
									fill={conditionToColor(
										this.props.teeth[55].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="1" onClick={() => this.props.onClick(61)}>
							<g>
								<use
									xlinkHref="#iso-61"
									fill={conditionToColor(
										this.props.teeth[61].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" onClick={() => this.props.onClick(62)}>
							<g>
								<use
									xlinkHref="#iso-62"
									fill={conditionToColor(
										this.props.teeth[62].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" onClick={() => this.props.onClick(63)}>
							<g>
								<use
									xlinkHref="#iso-63"
									fill={conditionToColor(
										this.props.teeth[63].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="4" onClick={() => this.props.onClick(64)}>
							<g>
								<use
									xlinkHref="#iso-64"
									fill={conditionToColor(
										this.props.teeth[64].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="5" onClick={() => this.props.onClick(65)}>
							<g>
								<use
									xlinkHref="#iso-65"
									fill={conditionToColor(
										this.props.teeth[65].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="1" onClick={() => this.props.onClick(71)}>
							<g>
								<use
									xlinkHref="#iso-71"
									fill={conditionToColor(
										this.props.teeth[71].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" onClick={() => this.props.onClick(72)}>
							<g>
								<use
									xlinkHref="#iso-72"
									fill={conditionToColor(
										this.props.teeth[72].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" onClick={() => this.props.onClick(73)}>
							<g>
								<use
									xlinkHref="#iso-73"
									fill={conditionToColor(
										this.props.teeth[73].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="4" onClick={() => this.props.onClick(74)}>
							<g>
								<use
									xlinkHref="#iso-74"
									fill={conditionToColor(
										this.props.teeth[74].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="5" onClick={() => this.props.onClick(75)}>
							<g>
								<use
									xlinkHref="#iso-75"
									fill={conditionToColor(
										this.props.teeth[75].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="1" onClick={() => this.props.onClick(81)}>
							<g>
								<use
									xlinkHref="#iso-81"
									fill={conditionToColor(
										this.props.teeth[81].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" onClick={() => this.props.onClick(82)}>
							<g>
								<use
									xlinkHref="#iso-82"
									fill={conditionToColor(
										this.props.teeth[82].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" onClick={() => this.props.onClick(83)}>
							<g>
								<use
									xlinkHref="#iso-83"
									fill={conditionToColor(
										this.props.teeth[83].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="4" onClick={() => this.props.onClick(84)}>
							<g>
								<use
									xlinkHref="#iso-84"
									fill={conditionToColor(
										this.props.teeth[84].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="5" onClick={() => this.props.onClick(85)}>
							<g>
								<use
									xlinkHref="#iso-85"
									fill={conditionToColor(
										this.props.teeth[85].condition || "sound"
									)}
								/>
								<g>
									<use
