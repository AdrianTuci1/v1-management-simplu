...
export class MouthViewPermanentS extends React.Component<
	{
	...
	render()
		...
		return (
			<svg
				...
				viewBox="0 0 560 1255"
			>
				<defs>
					<path
						style={{ cursor: "pointer" }}
						d="M266.17 8.55 L197.86 21.38 L248.05 67.4 Z"
						id="iso-11"
					/>
					<path
						style={{ cursor: "pointer" }}
				...
				<g className="main">
					<g className="q1" transform="translate(0, 0) rotate(0)">
						<g className="1" transform="translate(-15, 0) rotate(10)" onClick={() => this.props.onClick(11)}>
							<g>
								<use
									xlinkHref="#iso-11"
									fill={conditionToColor(
										this.props.teeth[11].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" transform="translate(0,-55) rotate(25)" onClick={() => this.props.onClick(12)}>
							<g>
								<use
									xlinkHref="#iso-12"
									fill={conditionToColor(
										this.props.teeth[12].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" transform="translate(45,-95) rotate(45)" onClick={() => this.props.onClick(13)}>
							<g>
								<use
									xlinkHref="#iso-13"
									fill={conditionToColor(
										this.props.teeth[13].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="4" transform="translate(80,-95) rotate(60)" onClick={() => this.props.onClick(14)}>
							<g>
								<use
									xlinkHref="#iso-14"
									fill={conditionToColor(
						...
						<g className="5" transform="translate(70,-100) rotate(60)" onClick={() => this.props.onClick(15)}>
							<g>
								<use
									xlinkHref="#iso-15"
									fill={conditionToColor(
										this.props.teeth[15].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="6" transform="translate(100,-60) rotate(75)" onClick={() => this.props.onClick(16)}>
							<g>
								<use
									xlinkHref="#iso-16"
									fill={conditionToColor(
										this.props.teeth[16].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="7" transform="translate(95,-70) rotate(75)" onClick={() => this.props.onClick(17)}>
							<g>
								<use
									xlinkHref="#iso-17"
									fill={conditionToColor(
										this.props.teeth[17].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="8" transform="translate(110,-5) rotate(85)" onClick={() => this.props.onClick(18)}>
							<g>
								<use
									xlinkHref="#iso-18"
									fill={conditionToColor(
										this.props.teeth[18].condition || "sound"
									)}
								/>
								<g>
									<use
					...
					<g className="q2">
						<g className="1" transform="translate(-35, 96) rotate(-10)" onClick={() => this.props.onClick(21)}>
							<g>
								<use
									xlinkHref="#iso-21"
									fill={conditionToColor(
										this.props.teeth[21].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" transform="translate(-10,150) rotate(-20)" onClick={() => this.props.onClick(22)}>
							<g>
								<use
									xlinkHref="#iso-22"
									fill={conditionToColor(
										this.props.teeth[22].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" transform="translate(65,305) rotate(-45)" onClick={() => this.props.onClick(23)}>
							<g>
								<use
									xlinkHref="#iso-23"
									fill={conditionToColor(
										this.props.teeth[23].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="1" transform="translate(0, 0) rotate(0)" onClick={() => this.props.onClick(31)}>
							<g>
								<use
									xlinkHref="#iso-31"
									fill={conditionToColor(
										this.props.teeth[31].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" transform="translate(0, 0) rotate(0)" onClick={() => this.props.onClick(32)}>
							<g>
								<use
									xlinkHref="#iso-32"
									fill={conditionToColor(
										this.props.teeth[32].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" transform="translate(0, 0) rotate(0)" onClick={() => this.props.onClick(33)}>
							<g>
								<use
									xlinkHref="#iso-33"
									fill={conditionToColor(
										this.props.teeth[33].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="4" transform="translate(0, 0) rotate(0)" onClick={() => this.props.onClick(34)}>
							<g>
								<use
									xlinkHref="#iso-34"
									fill={conditionToColor(
										this.props.teeth[34].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="5" onClick={() => this.props.onClick(35)}>
							<g>
								<use
									xlinkHref="#iso-35"
									fill={conditionToColor(
										this.props.teeth[35].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="6" onClick={() => this.props.onClick(36)}>
							<g>
								<use
									xlinkHref="#iso-36"
									fill={conditionToColor(
										this.props.teeth[36].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="7" onClick={() => this.props.onClick(37)}>
							<g>
								<use
									xlinkHref="#iso-37"
									fill={conditionToColor(
										this.props.teeth[37].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="8" onClick={() => this.props.onClick(38)}>
							<g>
								<use
									xlinkHref="#iso-38"
									fill={conditionToColor(
										this.props.teeth[38].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="1" onClick={() => this.props.onClick(41)}>
							<g>
								<use
									xlinkHref="#iso-41"
									fill={conditionToColor(
										this.props.teeth[41].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="2" onClick={() => this.props.onClick(42)}>
							<g>
								<use
									xlinkHref="#iso-42"
									fill={conditionToColor(
										this.props.teeth[42].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="3" onClick={() => this.props.onClick(43)}>
							<g>
								<use
									xlinkHref="#iso-43"
									fill={conditionToColor(
										this.props.teeth[43].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="4" onClick={() => this.props.onClick(44)}>
							<g>
								<use
									xlinkHref="#iso-44"
									fill={conditionToColor(
										this.props.teeth[44].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="5" onClick={() => this.props.onClick(45)}>
							<g>
								<use
									xlinkHref="#iso-45"
									fill={conditionToColor(
										this.props.teeth[45].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="6" onClick={() => this.props.onClick(46)}>
							<g>
								<use
									xlinkHref="#iso-46"
									fill={conditionToColor(
										this.props.teeth[46].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="7" onClick={() => this.props.onClick(47)}>
							<g>
								<use
									xlinkHref="#iso-47"
									fill={conditionToColor(
										this.props.teeth[47].condition || "sound"
									)}
								/>
								<g>
									<use
						...
						<g className="8" onClick={() => this.props.onClick(48)}>
							<g>
								<use
									xlinkHref="#iso-48"
									fill={conditionToColor(
										this.props.teeth[48].condition || "sound"
									)}
								/>
								<g>
									<use
